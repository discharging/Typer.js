class Typer {
    constructor(element) {
        ...
        this.delim = element.dataset.delim || ",";
        this.words = element.dataset.words || "override these,sample typing";
        this.words = this.words.split(this.delim).filter((v) => v); // non empty words
        ...
        this.colors = element.dataset.colors || "black";
